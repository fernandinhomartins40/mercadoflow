...
const MainLayout: React.FC<MainLayoutProps> = ({ children }) => {
  ...
  const navigation = [
    ...
    { name: 'Market Intelligence', href: '/market', icon: 'M16 8v8m-4-5v5m-4-2v2m-2 4h12a2 2 0 002-2V6a2 2 0 00-2-2H6a2 2 0 00-2 2v12a2 2 0 002 2z' },
    { name: 'Industry Benchmarks', href: '/industry', icon: 'M7 12l3-3 3 3 4-4M8 21l4-4 4 4M3 4h18M4 4h16v12a1 1 0 01-1 1H5a1 1 0 01-1-1V4z' },
  ];
